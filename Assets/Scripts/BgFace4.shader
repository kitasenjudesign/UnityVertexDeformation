...
#pragma exclude_renderers d3d11 gles
        ...
        float4 getNewVertPosition( float4 v, appdata_full appdata )
		{
            ...
            vv.xyz += appdata.normal.xyz * _Normal;// * snoise( vv.xyz );
            ...
            //vv.xyz += appdata.normal.xyz * _Normal;// * snoise( vv.xyz + _Time.x + 10) * 0.5;
